const Constants = {
    DashboardTrayHeader1: `Welcome to Frostlake !`,
    DashboardTrayHeader2: `Create a workspace and start realtime analysis instantly.`,
    HomeHeader1: `Let's build`,
    HomeHeader2: ` from here instantly.`,
    ...
    NoDataFoundMessage: `No Analytics Data Found`,
